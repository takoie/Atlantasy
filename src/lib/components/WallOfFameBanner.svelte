...
{#if announcement && !isDismissed}
  <div
    class="relative overflow-hidden rounded-xl border border-amber-500/30 bg-gradient-to-r from-amber-950/40 via-purple-950/30 to-slate-900/60 p-4 shadow-lg backdrop-blur-md transition-all duration-300"
  >
    <!-- Bakgrunns-glow -->
    <div
    ...
    <div class="flex items-start justify-between gap-4">
      <div class="flex items-start gap-3">
        <!-- Vinnerikon / Pokal -->
        <div
          class="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-gradient-to-br from-amber-400 to-amber-600 text-slate-950 shadow-md shadow-amber-500/20"
        >
          {#if announcement.type === "winner_celebration"}
        ...
        <div>
          ...
          <p class="mt-1 text-xs text-slate-300 leading-relaxed max-w-3xl">
      ...
      <button
        ...
        class="rounded p-1 text-slate-400 hover:bg-slate-800/60 hover:text-slate-200 transition-colors"
      >
        <X class="h-4 w-4" />
      </button>
    </div>
